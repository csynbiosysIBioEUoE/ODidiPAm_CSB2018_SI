%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Simulations to compute SSE for the MIP model 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
results_folder = strcat('MIP_Experimental',datestr(now,'yyyy-mm-dd-HHMMSS'));
short_name     = strcat('MIP');
...
y0 = M3D_steady_state_Experimental(model.par,0);
...
for iexp=1:length(exps_indexall)
    ...
    y0_to_use = M3D_steady_state_Experimental(model.par,0);   
