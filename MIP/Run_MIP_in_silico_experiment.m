function [] = Run_MIP_in_silico_experiment( resultBase, numExperiments )
% This function calls MIP_in_silico.m to simulate the MIP model to a
% step in IPTG (the value of which is specified by IPTGExt) lasting 24
% hours. It has been used to simulate the MIP dose response curve as well
