function [out] = fit_to_MIP(epccOutputResultFileNameBase,epcc_exps,global_theta_guess)
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% fit_to_MIP - runs PE of the M3D model structure to the experimental data acquired
% in \ref 7 of the paper.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    M3D_load_model_Experimental; 

    % Initial guesses for theta
    global_theta_min = [6.4667e-7,6.4667e-4,0.5,2,1.2833e-4,0.0041,9.9667e-7,2e-4,10]; %1/sec
    global_theta_max = [0.0083,0.0083,4.9,10,0.0038,0.1134,0.0041,3.6167e-4,100];

    global_theta_guess = global_theta_guess';
    
    % Compute the steady state considering the initial theta guess and 0 IPTG
    y0 = M3D_steady_state_Experimental(global_theta_guess,0);
